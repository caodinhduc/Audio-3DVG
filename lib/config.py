...
def get_parser():
    ...
    ### pretrain
    parser.add_argument('--pretrain', type=str, default='checkpoints/InstanceRefer_xyzrgb', help='path to pretrain model')
...
# path
CONF.PATH = EasyDict()
CONF.PATH.BASE = "/home/duccd/Desktop/InstanceRefer/" 
